...
static_assert(
    std::is_same_v<decltype(pond::ui::experimental::kRectangleFacadeExperimentalNotice),
...
static_assert(std::is_same_v<decltype(std::declval<pond::ui::experimental::RectangleRenderer&>()
                                          .Record(std::declval<pond::render::RenderFrame&>(),
                                                  ...
                                                  std::declval<
                                                      pond::ui::experimental::RectanglePaint>())),
                             pond::core::Result<
                                 pond::ui::experimental::RectangleRecordOutcome>>);
static_assert(std::is_same_v<decltype(std::declval<pond::ui::experimental::RectangleRenderer&>()
                                          .Record(std::declval<pond::render::RenderFrame&>(),
                                                  std::declval<const pond::ui::UiTargetMetrics&>(),
