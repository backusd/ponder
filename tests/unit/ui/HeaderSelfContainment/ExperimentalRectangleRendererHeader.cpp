...
static_assert(std::is_same_v<decltype(pond::ui::experimental::kRectangleFacadeExperimentalNotice), const std::string_view>);
static_assert(std::is_same_v<decltype(std::declval<pond::ui::experimental::RectangleRenderer&>().Record(
                                 std::declval<pond::render::RenderFrame&>(), std::declval<const pond::ui::UiTargetMetrics&>(),
...
static_assert(
    std::is_same_v<decltype(std::declval<pond::ui::experimental::RectangleRenderer&>().Record(
                       std::declval<pond::render::RenderFrame&>(), std::declval<const pond::ui::UiTargetMetrics&>(), std::declval<RectangleBatch>())),
                   pond::core::Result<pond::ui::experimental::RectangleRecordOutcome>>);
