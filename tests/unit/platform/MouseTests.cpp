...
static_assert(std::is_same_v<std::underlying_type_t<pond::platform::MouseButton>,
                             std::uint8_t>);
static_assert(std::is_scoped_enum_v<pond::platform::SystemCursorShape>);
static_assert(std::is_same_v<
              std::underlying_type_t<pond::platform::SystemCursorShape>,
              std::uint8_t>);
static_assert(pond::platform::MouseButton{} ==
              pond::platform::MouseButton::Unknown);
static_assert(pond::platform::SystemCursorShape{} ==
...
TEST(MouseTests, DefinesDistinctSupportedButtons)
{
    constexpr std::array buttons{
        pond::platform::MouseButton::Unknown,
        pond::platform::MouseButton::Left,
        pond::platform::MouseButton::Right,
        pond::platform::MouseButton::Middle,
        pond::platform::MouseButton::X1,
        pond::platform::MouseButton::X2};
