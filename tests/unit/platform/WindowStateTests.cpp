...
static_assert(std::is_same_v<
              std::underlying_type_t<pond::platform::WindowPresentation>,
              std::uint8_t>);
static_assert(std::is_same_v<
              std::underlying_type_t<pond::platform::WindowDecoration>,
              std::uint8_t>);
static_assert(std::is_same_v<std::underlying_type_t<pond::platform::WindowState>,
                             std::uint8_t>);
...
{
    EXPECT_EQ(static_cast<std::uint8_t>(
                  pond::platform::WindowDecoration::System),
              0U);
    EXPECT_EQ(static_cast<std::uint8_t>(
...
TEST(PlatformWindowStateTests, DefinesStableStateAlternatives)
{
    ...
    EXPECT_EQ(static_cast<std::uint8_t>(pond::platform::WindowState::Minimized),
              1U);
    EXPECT_EQ(static_cast<std::uint8_t>(pond::platform::WindowState::Maximized),
              2U);
}
} // namespace
