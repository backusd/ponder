...
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().SetMouseCapture(true)),
                   pond::core::VoidResult>);
static_assert(std::is_same_v<decltype(std::declval<const pond::platform::PlatformRuntime&>()
                                          .GetGlobalMousePosition()),
                             pond::core::Result<pond::platform::LogicalPoint>>);
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().SetSystemCursor(
                       pond::platform::SystemCursorShape::Default)),
                   pond::core::VoidResult>);
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().ShowCursor()),
                   pond::core::VoidResult>);
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().HideCursor()),
                   pond::core::VoidResult>);
static_assert(
    std::is_same_v<
        decltype(std::declval<const pond::platform::PlatformRuntime&>().IsCursorVisible()), bool>);
static_assert(std::is_same_v<
              decltype(std::declval<const pond::platform::PlatformRuntime&>().GetClipboardText()),
...
static_assert(std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>()
                             ...
                             pond::core::VoidResult>);
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().ShowOpenFileDialog(
                       std::declval<const pond::platform::OpenFileDialogDesc&>())),
                   pond::core::Result<pond::platform::DialogRequestId>>);
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().ShowSaveFileDialog(
                       std::declval<const pond::platform::SaveFileDialogDesc&>())),
                   pond::core::Result<pond::platform::DialogRequestId>>);
static_assert(
    std::is_same_v<decltype(std::declval<pond::platform::PlatformRuntime&>().ShowOpenFolderDialog(
...
{
    const pond::platform::PlatformRuntimeDesc desc{.applicationName = "Molecular Workbench",
