...
[[maybe_unused]] constexpr pond::render::RenderTargetSnapshot kSnapshot{
    ...
    pond::platform::PixelSize{.width = 320U, .height = 240U},
    pond::platform::LogicalSize{.width = 320U, .height = 240U},
    true,
...
[[maybe_unused]] constexpr pond::render::RenderFrameMetrics kFrameMetrics{
    ...
    .logicalSize = pond::platform::LogicalSize{.width = 320U, .height = 240U},
    .pixelSize = pond::platform::PixelSize{.width = 640U, .height = 480U},
